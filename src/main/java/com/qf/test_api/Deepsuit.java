...
public class Deepsuit {
    private final HttpClient client;
    private final String apiKey;
    private final String baseUrl;
    private final ObjectMapper objectMapper;

    public Deepsuit(String apiKey, String baseUrl) {
    ...
    public String extractCity(String text) {
        try {
            ...
            requestBody.put("messages", List.of(
                    Map.of(
                            "role", "system",
                            "content", "请根据用户提供的天气信息，以及用户的问题给出合适的建议,简短即可"
                    ),
    ...
    public static String main(String prompt) {
        String apiKey = "key";
        Deepsuit detector = new Deepsuit(apiKey);

        String answer = detector.extractCity(prompt);
