...
public class DeepSeekcity {
    private final HttpClient client;
    private final String apiKey;
    private final String baseUrl;
    private final ObjectMapper objectMapper;

    public DeepSeekcity(String apiKey, String baseUrl) {
    ...
    public DeepSeekcity(String apiKey) {
    ...
    public String extractCity(String text) {
        try {
            ...
            requestBody.put("messages", List.of(
                    Map.of("role", "system",
                            "content", "你是一个专门提取用户问题中出现城市的专家。只返回城市名，不要包含（市、区、县）其他内容。"),
            ...
            if (response.statusCode() == 200) {
                ...
                if (!chatResponse.getChoices().isEmpty()) {
                    ...
                    System.out.println("提取的原始城市: " + city);
